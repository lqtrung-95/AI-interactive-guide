        ...
        {sidebarOpen && (
          <div style={{ width: 220, minWidth: 220, borderRight: "1px solid #e5e7eb", background: "#fff", overflowY: "auto", padding: "8px 0" }}>
            {MODULES.map((m, mi) => (
              <div key={m.id}>
                <button
                  onClick={() => { setActiveModule(mi); setActiveSection(0); }}
                  style={{
                ...
                {activeModule === mi && m.sections.map((s, si) => (
                  <button
                    ...
                    style={{
                      ...
                      background: activeSection === si ? `${m.color}18` : "transparent",
                      fontFamily: "sans-serif", fontSize: 11, color: activeSection === si ? m.color : "#888",
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: 24, paddingTop: 16, borderTop: "1px solid #e5e7eb" }}>
            <button
              ...
              style={{
                ...
                cursor: activeModule === 0 && activeSection === 0 ? "not-allowed" : "pointer",
                opacity: activeModule === 0 && activeSection === 0 ? 0.3 : 1,
